...
const TvDetails = () => {
  ...
  return info ? (
    <div
      ...
      className="w-screen relative h-[230vh] px-4 md:px-10 py-10"
    >
      ...
      <div className="flex flex-col md:flex-row w-full">
        <img
          ...
          src={`https://image.tmdb.org/t/p/original/${
            info.detail.poster_path || info.detail.backdrop_path || no_image
          }`}
          alt=""
        />
      ...
      <h1 className="text-3xl font-bold mt-10">Seasons</h1>

      <div className="w-full flex overflow-x-auto mb-5 p-5 space-x-5">
        {info.detail.seasons.length > 0 ? (
          info.detail.seasons.map((s, i) => (
            <div className="w-[30vh] mr-10" key={i}>
              <img
                className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] rounded-lg min-w-[15vw] h-[40vh] object-cover"
                src={`https://image.tmdb.org/t/p/original/${
                  s.poster_path || no_image
                }`}
                alt=""
              />
          ...
          <h1 className="text-3xl font-bold">No Season Available</h1>
        )}
      </div>
